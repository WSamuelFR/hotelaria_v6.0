            ...
            <form id="cadastroForm" autocomplete="off" action="../controllers/cadastro_process.php" method="POST">
                ...
                <fieldset class="border p-3 mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3"><label for="senha" class="form-label">Senha de Acesso: para hospedes colocar o CPF/CNPJ!</label><input type="password" class="form-control" id="senha" name="senha" required></div>
                    </div>
                </fieldset>
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="/../public/index.php" class="btn btn-secondary btn-lg ms-3">
